...
const main = async () => {
  ...
  */
  ...
  const timRecipe = await recipes.addRecipe(
    ...
    "Whiskey sour",
    "whiskey",
    "lemon,simple syrup, bitters, egg white",
    "Add one shot of whiskey, half a lemon, oz of simple syrup, egg white, and shake. Then add bitters for taste.",
    "3",
    "https://www.youtube.com/watch?v=WLUqBrih0fU"
  );
